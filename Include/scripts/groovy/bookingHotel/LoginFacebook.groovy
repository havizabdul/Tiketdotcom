...
class LoginFacebook {
	...
	@Given("user memilih fitur login")
	def user_memilih_fitur_login() {
		WebUI.click(findTestObject('Object Repository/a_Log in'))
		WebUI.delay(2)
	}

	@When("user memilih menggunakan facebook")
	def user_memilih_menggunakan_facebook() {
		WebUI.click(findTestObject('Object Repository/div_Masuk dengan Facebook'))
	}

	@Then("user melakukan login")
	def user_melakukan_login() {
